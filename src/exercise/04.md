...
It's illuminating the path to building my own dictionary of custom components step by step. Again, making me very aware of everything that goes on under the hood, so to speak. Interesting to see that I can build a typed components world inside inside a Javascript world. A very effective first step to testing the app, and also to properly document each component.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=04%3A%20Creating%20custom%20components&em=jaime.ferbec%40gmail.com).
