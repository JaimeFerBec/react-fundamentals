...
I revisited the core/basic concepts on how to programmatically manipulate the DOM via Javascript. But also interestingly learned for the first time ever that the browser "fills in the gaps" for you, i.e. it creates the html, body, and header nodes even if you don't actually write them in your html source file.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=01%3A%20Basic%20JavaScript-rendered%20Hello%20World&em=jaime.ferbec%40gmail.com).
