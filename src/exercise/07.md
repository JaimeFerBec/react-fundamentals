...
I learnt about the importance of keys, and I first got a hint of the importance of states, whether the state is managed by React or the browser.

However, at least for me, in order to get the full meaning and knowledge out of this lesson I had to go and read the cited articles to get that explanation of what really is going on under the hood. Even though I did the same for previous lessons (reading the cited articles), it did not feel like it was necessary to get all of the juice out of every exercise.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=07%3A%20Rendering%20Arrays&em=jaime.ferbec%40gmail.com).
